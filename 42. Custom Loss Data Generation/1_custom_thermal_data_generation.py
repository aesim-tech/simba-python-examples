...
if __name__ == "__main__":
    ...
    for temperature in temperatures:
        for load_current in load_currents:
            ...
            simulation_args.append((sim_index, temperature, load_current, fundamental_frequency, results, lock))
            sim_index += 1
            # Simulations at twice the fundamental frequency
            simulation_args.append((sim_index, temperature, load_current, 2 * fundamental_frequency, results, lock))
            sim_index += 1
    ...
    if os.environ.get("SIMBA_SCRIPT_TEST"): 
        exit()  # Skip plotting in test environment
